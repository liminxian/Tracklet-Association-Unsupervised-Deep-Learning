...
from reid.evaluators_video import Evaluator
from reid.utils.data import transforms as T
from reid.utils.data.preprocessor_image import Preprocessor_Image
from reid.utils.data.preprocessor_video import Preprocessor_Video
...
def get_data(name, split_id, data_dir, height, width, batch_size, num_instances, workers, combine_trainval):
    ...
    test_loader = DataLoader(
        Preprocessor_Video(test_set, transform=test_transformer, seq_len=seq_len, sample='random'),
        batch_size=int(batch_size / seq_len), num_workers=workers,
