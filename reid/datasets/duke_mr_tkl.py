...
class DukeMTMC_MRTKL(BaseVideoDataset):
    """
    DukeMTMCVidReID
    ...
    Dataset statistics:
    # identities: 702 (train) + 1110 (test, 702 query)
    ...
    def __init__(self, root='data', min_seq_len=0, verbose=True, **kwargs):
        ...
        self.split_train_json_path = osp.join(self.dataset_dir, 'info/train_ext_filter.json')
        ...
        train = self._process_train_dir(self.train_dir, self.split_train_json_path, relabel=True, filter=False)
    ...
    def _process_train_dir(self, dir_path, json_path, relabel, tid_start=0, filter=True):
        ...
        for pdir in pdirs:
            ...
            for tdir in tdirs:
                ...
                # new naming format: 0001_C6_030823.jpg
